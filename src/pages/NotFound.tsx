  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <div className="mt-6 flex gap-3">
        ...
        <Link
          to="/schedule"
          className="rounded-lg border border-slate-200 bg-slate-100 px-5 py-2.5 text-sm text-slate-600 transition hover:bg-slate-200 dark:border-white/10 dark:bg-white/5 dark:text-slate-300 dark:hover:bg-white/10"
        >
          查看赛程
        </Link>
      </div>
